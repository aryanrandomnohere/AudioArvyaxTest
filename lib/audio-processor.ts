export class AudioProcessor {
  ...
  async separateChannels(audioFile: File): Promise<{
    ...
    console.log("[v0] Left channel sample range:", Math.min(...leftChannelData), "to", Math.max(...leftChannelData))
    console.log("[v0] Right channel sample range:", Math.min(...rightChannelData), "to", Math.max(...rightChannelData))
    ...
    console.log("[v0] Channel separation complete - Left blob size:", leftBlob.size, "Right blob size:", rightBlob.size)
